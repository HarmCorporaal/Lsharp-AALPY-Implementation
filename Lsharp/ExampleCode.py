...
# Input Dot file:
dot_file = 'Lsharp/DotFiles/GnuTLS_3.3.8_server_full.dot'
...
def run_lsharp():
    ...
    L_sharp = Lsharp(input_al, sul_mealy, perfect_oracle, extension_rule="Nothing", separation_rule="SepSeq", max_learning_rounds=50)
...
print(f"states: {len(mealy_machine.states)} inp: {len(input_al)}, compl: {len(mealy_machine.states) * len(input_al)} ")
# L_sharp.run_Lsharp()
